    ...
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          ...
          Text("Effective date: August 24, 2018"),
          Padding(
            padding: EdgeInsets.symmetric(vertical: 4.0),
          ),
          Text(
              "BM Trading GmbH ('us', 'we', or 'our') operates the website and the Trade Buddy mobile application (the 'Service')."),
          Padding(
            padding: EdgeInsets.symmetric(vertical: 4.0),
          ),
          Text(
          ...
          Text("BM Trading GmbH uses the collected data for various purposes:"),
          ...
          Text("To send topic related newsletters and advertising material"),
          Padding(
            padding: EdgeInsets.symmetric(vertical: 4.0),
          ),
          Text(
          ...
          Text(
              "BM Trading GmbH will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information."),
          Padding(
            padding: EdgeInsets.symmetric(vertical: 4.0),
          ),
          Text(
          ...
          Text(
              "BM Trading GmbH may disclose your Personal Data in the good faith belief that such action is necessary to:"),
          Padding(
            padding: EdgeInsets.symmetric(vertical: 4.0),
          ),
          ...
          Text(
              "To protect and defend the rights or property of BM Trading GmbH"),
          Padding(
            padding: EdgeInsets.symmetric(vertical: 4.0),
          ),
          Text(
          ...
          Text("By email: info@bmtrading.de"),
        ],
      ),
    );
  }
